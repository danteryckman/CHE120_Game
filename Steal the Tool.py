...
# CC - gets a font with a specified size, using a font file located in the 'Steal-the-Tool/assets/' directory
...
def play():
    ...
    while True:
        ...
        if current_state == start:
            ...
            text = ['You are a UofT student who has come to the University of Waterloo campus for one thing.', 'You want to Steal-the-Tool-main/Steal-the-Tool-main!!!!', 'You can\'t help but notice that the campus is much nicer than that of UofT.', 'You came to Waterloo to Steal-the-Tool-main/Steal-the-Tool-main because you feel that if UofT had the TOOL, the school will finally have the best engineering program in Canada.', 'Before you begin your search, a goose approaches you. What should you do?', '1. Give the goose $20', '2. Give goose a treat', '3. Ignore goose', '4. Frighten goose', '(choose by pressing number associated with option)']
     ...
     # DR - The same code is used for almost all of the rooms with the only difference being the text and the image that is printed as well as text_rect which will use midleft and a slightly different y value
        ...
        if current_state == goose_choice1:
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('Steal-the-Tool/assets/you_died.png'),(0,0)) # DR - Only prints the image as this room does not require any text
        elif current_state == rat_death_choice:
            screen.fill('black')
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('Steal-the-Tool/assets/win.png'),(265,0)) # DR - Only prints the image as this room does not require any text
        elif current_state == goose_death_choice:
            screen.fill('black')
