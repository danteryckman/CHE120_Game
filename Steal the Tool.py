    ...
    while True:
     ...
     # DR - The same code is used for almost all of the rooms with the only difference being the text and the image that is printed as well as text_rect which will use midleft and a slightly different y value
        ...
        if current_state == goose_choice1:
            screen.fill('black')
            screen.blit(pygame.image.load('assets/goose_victory.png'),(362,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/goose_treat.png'),(369,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/ignore_goose.png'),(380,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/goose_scare.png'),(380,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/RCH.png'),(78,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/SLC.png'),(232,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/E7.png'),(180,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/library_death.png'),(372,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/chased_shadow.png'),(367,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/shadow_$20.png'),(363,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/claudio_soap.png'),(366,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/dante.png'),(363,0))
            text = ['You decide to check the study lounge for the TOOL. You think they may have it on display to give the','Engineering students some power by being in it\s presence. You search for about 10 minutes before seeing','a student named Dante sitting in a chair, working on a project called \“Steal-the-Tool-main/Steal-the-Tool-main\”. You approach','him and begin to make conversation about Waterloo things to try and gain his trust. Eventually, he','offers you an item from the table in front of him as a kind gesture. You think these items are a bit','weird to be a kind gesture, but you realize these items have potential to be useful for you.']
            pygame.draw.rect(screen,'gray',[0,520,width,200])
            for line in text:
                written_text = text_font.render(line, True, 'black')
                text_rect = written_text.get_rect(topleft = (10,height-20*len(text)+y-(200/len(text))))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/robot_death.png'),(359,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/in_E7.png'),(179,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/broken_elevator.png'),(374,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/claudio.png'),(369,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/quidditch_death.png'),(367,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/leaving_room.png'),(369,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/ladder.png'),(366,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/spider.png'),(369,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/tim_hortons.png'),(369,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/guards.png'),(366,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/distraction.png'),(380,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/guard_death.png'),(368,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/airdrop.png'),(369,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/sale.png'),(366,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/chem_warfare.png'),(367,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/rooftop.png'),(367,0))
            text = ['You successfully Steal-the-Tool-main/Steal-the-Tool-main and run onto the roof, you need to think of a way to get down.', '1 to hang glide off the roof', '2 to zipline down on the powerlines using the TOOL', '3 to go back down the way you came up']
            pygame.draw.rect(screen,'gray',[0,520,width,200])
            for line in text:
                written_text = text_font.render(line, True, 'black')
                text_rect = written_text.get_rect(topleft = (10,height-20*len(text)+y-(200/len(text))))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/hang_glider_death.png'),(367,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/zipline_death.png'),(360,0))
            ...
            screen.fill('black')
            screen.blit(pygame.image.load('assets/wrench_stollen_success.png'),(344,0))
